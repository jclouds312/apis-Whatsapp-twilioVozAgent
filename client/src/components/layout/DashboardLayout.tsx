...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { icon: Phone, label: "Extensions Admin", path: "/admin/extensions", badge: "New" },
    { icon: MessageSquare, label: "WhatsApp Admin", path: "/admin/whatsapp", badge: "New" },
    { icon: Users, label: "Accounts", path: "/admin/accounts", badge: "New" },
