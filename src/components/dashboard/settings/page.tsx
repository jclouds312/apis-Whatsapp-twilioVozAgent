                            ...
                            <TableRow key={key.id}>
                                ...
                                <TableCell>
                                    <div className="flex items-center gap-2 font-mono text-muted-foreground">
                                       <span className="text-sm">{getDisplayKey(key)}</span>
                                    ...
                                    <Dialog open={editKeyOpen && selectedKey?.id === key.id} onOpenChange={(open) => { if (!open) setSelectedKey(null); setEditKeyOpen(open)}}>
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="end">
                                                ...
                                                <DropdownMenuItem className="text-destructive focus:text-destructive" onClick={() => handleDeleteKey(key)}>Delete</DropdownMenuItem>
                                            </DropdownMenuContent>
                                        </DropdownMenu>
                                        <DialogContent>
