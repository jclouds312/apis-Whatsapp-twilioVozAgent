...
const roleClasses: Record<string, string> = {
    'Admin': 'bg-destructive/10 text-destructive dark:bg-destructive/20 border-destructive/20',
    ...
    'Developer': 'bg-primary/10 text-primary dark:bg-primary/20 border-primary/20',
                            ...
                            <TableBody>
                                ...
                                {users?.map((user) => (
                                    <TableRow key={user.id}>
                                        ...
                                        <TableCell>
                                             <Badge variant="outline" className={cn(roleClasses[user.role])}>{user.role}</Badge>
                                        </TableCell>
                                        <TableCell>
                                            <Dialog>
                                                <DropdownMenu>
