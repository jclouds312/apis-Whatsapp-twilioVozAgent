...
"[project]/src/app/dashboard/function-connect/data:05d353 [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$dashboard$2f$function$2d$connect$2f$data$3a$05d353__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/dashboard/function-connect/data:05d353 [app-ssr] (ecmascript) <text/javascript>");
'use client';
;
;
;
...
function ChatMessage({ conversation, currentUserAvatar }) {
    ...
    const handleSend = async ()=>{
        if (input.trim() && conversation && user && firestore) {
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$dashboard$2f$function$2d$connect$2f$data$3a$05d353__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["sendWhatsAppMessage"])(conversation.contactId, tempInput);
            if (result.success) {
                toast({
                    title: 'Message Sent',
...
//# sourceMappingURL=src_5014e183._.js.map